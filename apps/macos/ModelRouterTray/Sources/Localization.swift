...
enum RouterChineseText {
  static let values: [String: String] = [
    ...
    "ChatGPT account selection saved. Restart Codex to use it.": "ChatGPT 账户选择已保存。请重启 Codex 后使用。",
    "weekly": "每周",
    "monthly": "每月",
    "current": "当前",
    "ChatGPT accounts": "ChatGPT 账户",
    "%d saved accounts": "已保存 %d 个账户",
    "Choose which saved login native Codex will use after its next restart.": "选择原生 Codex 下次重启后使用的已保存登录。",
